  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { heading: "Billing & Payment", body: "SharkCluster plan fees are billed monthly or as described in your selected plan. Cloud provider costs are billed separately at provider rates. Optional add-ons like offsite backup storage are billed per usage. Refunds are governed by our Refund Policy.", link: { to: "/legal/refund", label: "Read the Refund Policy" } },
